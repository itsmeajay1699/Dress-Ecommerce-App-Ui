...
final kEncodeSansBold = GoogleFonts.encodeSans(fontWeight: FontWeight.bold);
final kEncodeSansSemiBold = GoogleFonts.encodeSans(fontWeight: FontWeight.w600);
final kEncodeSansMediumBold =
    GoogleFonts.encodeSans(fontWeight: FontWeight.w500);
final kEncodeSansRegularBold =
    GoogleFonts.encodeSans(fontWeight: FontWeight.w400);
